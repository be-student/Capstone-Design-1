...
def main():
    ...
    # ── Custom Theme: Industrial Data Intelligence ──────────────────────
    st.markdown("""
    <style>
    /* ── Google Font import ── */
    ...
    /* ── Global background ── */
    .stApp {
        background: linear-gradient(135deg, var(--bg-primary) 0%, #0f172a 50%, #111827 100%) !important;
    ...
    h1 {
        ...
        background: linear-gradient(135deg, #f1f5f9 0%, var(--accent-mint) 100%);
    ...
    /* ── Buttons ── */
    .stButton > button {
        background: linear-gradient(135deg, rgba(52, 211, 153, 0.15) 0%, rgba(34, 211, 238, 0.15) 100%) !important;
        color: var(--accent-mint) !important;
    ...
    .stButton > button:hover {
        background: linear-gradient(135deg, rgba(52, 211, 153, 0.3) 0%, rgba(34, 211, 238, 0.3) 100%) !important;
        border-color: var(--accent-mint) !important;
        box-shadow: 0 0 16px rgba(52, 211, 153, 0.2) !important;
    ...
    .stApp > header {
        background: linear-gradient(90deg, var(--bg-primary) 0%, rgba(52, 211, 153, 0.05) 50%, var(--bg-primary) 100%) !important;
    ...
    # ── Plotly dark theme aligned with CSS palette ──
    import plotly.io as pio
    pio.templates["churn_dark"] = go.layout.Template(
        layout=go.Layout(
            paper_bgcolor="rgba(17, 24, 39, 0)",
            plot_bgcolor="rgba(17, 24, 39, 0)",
            font=dict(family="Outfit, sans-serif", color="#94a3b8", size=13),
            title=dict(font=dict(color="#f1f5f9", size=18)),
            colorway=["#34d399", "#22d3ee", "#fbbf24", "#fb7185",
